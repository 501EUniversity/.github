...
| [`xhs-need-radar`](https://github.com/501EUniversity/xhs-need-radar) | Pipeline | 小红书需求雷达 · 双周扫痛点 → Opus 4.7 生成 Top 3 MVP → 部署 · **v3.1+v3.2**(2026-05-17 一晚 9 个 systemic bug · S7 60min timeout+recovery / verifier G+H rubric / upstreamLibScout / Next.js scaffold / progressWatchdog SDK / staticAudit S7.5 / spec.deferred_to_v05) · 触发案例 `safari-atlas` 半人工 ship · v3.1+v3.2 改进**没在新 app 真实战验**(下次新 spec 跑 S1-S11 验贯通) |
